...
export const routes: Routes = [
    ...
    },
    {
        ...
        children: [
            ...
            {
                path: 'report',
                data: { breadcrumb: 'Painel de Controle', permission: 'report.view' },
                loadComponent: () =>
                    import('./modules/report/report.component').then(r => r.ReportComponent)
            },
            {
                path: 'catalog',
                data: { breadcrumb: 'Medicamentos', permission: 'catalog.view' },
                loadComponent: () =>
                    import('./modules/catalog/catalog.component').then(r => r.CatalogComponent)
            },
            {
                path: 'catalog/create',
                data: { breadcrumb: 'Cadastro de medicamento', permission: 'catalog.create' },
                loadComponent: () =>
                    import('./modules/catalog/form-medicine/form-medicine.component').then(r => r.FormMedicineComponent)
            },
            {
                path: 'catalog/edit/:id',
                data: { breadcrumb: 'Edição de medicamento', permission: 'catalog.update' },
                loadComponent: () =>
                    import('./modules/catalog/form-medicine/form-medicine.component').then(r => r.FormMedicineComponent)
            },
            {
                path: 'batch',
                data: { breadcrumb: 'Lote', permission: 'batch.view' },
                loadComponent: () =>
                    import('./modules/batch/batch.component').then(r => r.BatchComponent)
            },
            {
                path: 'batch/create',
                data: { breadcrumb: 'Entrada de Lote', permission: 'batch.create' },
                loadComponent: () =>
                    import('./modules/batch/form-batch/form-batch.component').then(r => r.FormBatchComponent)
            },
            {
                path: 'batch/edit/:id',
                data: { breadcrumb: 'Edição de Lote', permission: 'batch.update' },
                loadComponent: () =>
                    import('./modules/batch/form-batch/form-batch.component').then(r => r.FormBatchComponent)
            },
            {
                path: 'movement',
                data: { breadcrumb: 'Movimentação de Lote', permission: 'movement.view' },
                loadComponent: () =>
                    import('./modules/movement/movement.component').then(r => r.MovementComponent)
            },
            {
                path: 'movement/create',
                data: { breadcrumb: 'Criar Movimentação', permission: 'movement.create' },
                loadComponent: () =>
                    import('./modules/movement/form-movement/form-movement.component').then(r => r.FormMovementComponent)
            },
            {
                path: 'movement/edit/:id',
                data: { breadcrumb: 'Editar Movimentação', permission: 'movement.update' },
                loadComponent: () =>
                    import('./modules/movement/form-movement/form-movement.component').then(r => r.FormMovementComponent)
            },
            {
                path: 'dispersation',
                data: { breadcrumb: 'Atendimentos Realizados', permission: 'dispersation.view' },
                loadComponent: () =>
                    import('./modules/dispersation/dispersation.component').then(r => r.DispersationComponent)
            },
            {
                path: 'dispersation/create',
                data: { breadcrumb: 'Novo Atendimento', permission: 'dispersation.create' },
                loadComponent: () =>
            ...
            },
            {
                ...
                data: { breadcrumb: 'Editar Atendimento', permission: 'dispersation.update' },
                loadComponent: () =>
                    import('./modules/dispersation/form-dispersation/form-dispersation.component').then(r => r.FormDispersationComponent)
            },
            {
                path: 'alerts',
                data: { breadcrumb: 'Notificações', permission: 'alerts.view' },
                loadComponent: () =>
                    import('./modules/alerts/alerts.component').then(r => r.AlertsComponent)
            },
            {
                path: 'management',
                data: { breadcrumb: 'Usuários', permission: 'management.view' },
                loadComponent: () =>
            ...
            {
                path: 'patient',
                data: { breadcrumb: 'Pacientes', permission: 'patient.view' },
                loadComponent: () =>
